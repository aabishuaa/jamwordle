...
const targetWords = [
  ...
  const dictionary = [
    ...
    "rural",
    "shave",
    "badda", "mumma", "puppa", "foofa", "yasuh", "gwaan", "desso", "gwope", "agguh", "mussi",
    "nahve", "dweet", "bombo", "cyaan", "innah", "fofoo", "nevva", "pieca", "wodda", "tingz",
    "nosah", "cudda", "jussa", "crass", "doodo", "massa", "kakka", "innuh", "ginal", "peepi"
  ]
  ...
  const levelWords = patoisList.slice(0, 30);
...
function getDuplicateLetters(letters) {
    const letterCounts = {};
    const duplicates = [];
  ...
  function submitGuess() {
    ...
    if (!dictionary.includes(guess) && !patoisList.includes(guess)) {
  ...
  function flipTile(tile, index, array, guess) {
    ...
    tile.addEventListener(
        ...
        () => {
            ...
            const duplicateTargetLetters = getDuplicateLetters(targetLetters);
            const duplicateGuessLetters = getDuplicateLetters(guess.split(""));
            ...
            if ((duplicateTargetLetters.length==0 && duplicateGuessLetters.length==0)){
                if (guessLetter === targetLetter) {
                    ...
                    key.classList.add("wrong");
                        ...
                        if (duplicateGuessLetters.includes(guessLetter) && marker==true){
                            marker = false;
                            if (guessLetter === targetLetter) {
                                    tile.dataset.state = "correct"; // Green
                                    key.classList.add("correct");
  ...
  function showPopup(message) {
    ...
    // Define an event listener for the Next Level button within the showPopup function
    const nextLevelButton = document.getElementById("next-level-btn");
    nextLevelButton.addEventListener("click", () => {
      startNextLevel(true);
      popup.style.display = "none"; // Dismiss the popup after clicking the Next Level button
    });
  }
